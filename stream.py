...
if __name__ == '__main__':
    # 1. Start the Flask web server in a separate background thread FIRST
    print("\n--- Web Server Starting ---")
    print(f"Open this URL in your mobile browser:")
    print(f"http://127.0.0.1:5000 (Local PC testing)")
    print("Replace 127.0.0.1 with your PC's IP address for mobile testing.")
    print("---------------------------\n")
    ...
    # 2. Start the video processing on the MAIN thread
    # This guarantees the camera window will open successfully every time
    try:
        process_video()
